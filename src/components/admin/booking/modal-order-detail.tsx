...
export default function ModalOrderDetail({
    ...
    useEffect(() => {
        if (isOpen && tableId) {
            // Kiểm tra xem có data từ props không và id_order có hợp lệ không
            if (data && data.id_order && data.id_order > 0) {
                ...
                // Query từ DB nếu không có data hoặc id_order = 0/null
